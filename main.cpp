/*
Fourier-Motzkin-eleminiation
Author: Anna Claudia Renner
General comments:
	this file should compile with g++ main.cpp -std=c++11
	The program often throws some out_of_range exception, I don't know where the mistake is
*/
...
//Global variables for saving the sequences of A, b and coefficients and indices of lower bounds generated by the elimination
...
int main(int argc, const char *argv[])
{
	...
	int success = read_LP(argv[1]);
	if (success == EXIT_FAILURE){
		std::cerr << "The given LP could not be read.";
		return EXIT_FAILURE;
	}
